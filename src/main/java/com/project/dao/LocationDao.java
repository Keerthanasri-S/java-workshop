...
public class LocationDao {
    ...
    public LocationRep save(LocationRep location) {
        if (location.id() == null) {
            // INSERT
            String sql = """
    ...
    public Optional<LocationRep> findById(int id) {
    ...
    public List<LocationRep> findAll() {
    ...
    private LocationRep mapRow(ResultSet rs) throws SQLException {
        return new LocationRep(
                rs.getInt("id"),
                rs.getString("doorno"),
                rs.getInt("street"),
